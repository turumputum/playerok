...
sudo systemctl enable webka.service scheduler.service uart2mqtt.service usb_storage.service screen_sound_config.service
sudo systemctl start webka.service scheduler.service uart2mqtt.service usb_storage.service screen_sound_config.service
...
su playerok -c " xfconf-query -c xfce4-desktop -p  /backdrop/screen0/monitorHDMI-3/workspace0/last-image -s /home/playerok/playerok/linux_conf/wall_blue.JPG"
